        ...
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            <div className="flex flex-col items-center text-center gap-4">
                ...
                <p className="max-w-2xl mx-auto font-ovo">
                    ...
                    aliquid facilis velit odio maxime saepe eveniet amet ducimus dolorum molestias ipsam.
                </p>
            </div>

            <div className="flex flex-column sm:flex-row gap-4 mt-4 items-center">
                <a href="#contact" className="px-10 py-3 border rounded-full border-white bg-black flex items-center gap-2 text-white">Contact me <Image src={assets.right_arrow_white} alt="" className="w-4"/></a>
