...
const Contact = () => {
    ...
    return (
        <div id="contact" className="w-full max-w-screen-xl mx-auto py-0 scroll-mt-20 bg-[url('/footer-bg-color.png')] bg-no-repeat bg-center bg-[length:90%_auto]">
            <h1 className="text-center mb-2 text-lg font-ovo">Connect with me</h1>
            <h2 className="text-center text-5xl font-ovo">Get in touch</h2>

            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo">
                I&rsquo;d love to hear from you! If you have any questions, comments or feedback, please use the form below.
            </p>
            ...
            <form className="max-x-2xl mx-auto" onSubmit={onSubmit}>
                <div className="grid grid-cols-2 gap-6 mt-10 mb-8">
                    <input
                        ...
                        name="name"
                        id="name"
                        className="flex-1 outline-none border border-gray-400 rounded-md bg-white p-3"
                        required
                    />
                    <input
                        type="email"
